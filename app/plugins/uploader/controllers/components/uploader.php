...
class UploaderComponent extends Object {
	...
	public function resize($options) {
		...
		if ($this->transform($transform)) {
			return $this->_return($transform['target'], $options["width"]);
		} 
	 ...
	 */
        ...
        function generar_data($cueanexo,$final,$thumb,$descripcion){
            $this->delete($this->__data[$this->__current]["path"]);
            $data2["Foto"]["link"] = $this->__data[$this->__current]["path_$final"];
            $data2["Foto"]["thumb"] = $this->__data[$this->__current]["path_$thumb"];
            $data2["Foto"]["cueanexo"] = $cueanexo;
            $data2["Foto"]["revisada"] = false;
            $data2["Foto"]["deshabilitada"] = false;
            $data2["Foto"]["uploaded"] = $this->__data[$this->__current]["uploaded"];
            $data2["Foto"]["descripcion"] = $descripcion;
            return $data2;
        }
