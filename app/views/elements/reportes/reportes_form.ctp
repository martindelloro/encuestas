...
<div class="well titulo-general">
    ...
    <div class="row-fluid">
        <div class="popover-title"><b>Variables</b></div>
        <div class="span4"><?php echo $this->Form->input("variables",array("type"=>'select',"options"=>$variables,"label"=>"Variable 1 (vertical):","empty"=>true)); ?></div>
        <div class="span4"><?php echo $this->Form->input("carrera_nombre",array("type"=>'select',"options"=>$variables,"label"=>"Variable 2 (horizontal):","empty"=>true)); ?></div>
   
    </div>
        
    <div class="row-fluid">
        <div class="popover-title"><b>Filtros</b></div>
        <div class="span3"><?php echo $this->Form->input("sexo",array("type"=>'select',"options"=>$filtros,"label"=>false,"empty"=>true)); ?></div>
