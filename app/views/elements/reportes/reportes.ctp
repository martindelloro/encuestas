...
<div class="dropdown-menu" style="padding: 15px; padding-bottom: 0px;">
    <?php echo $this->Ajax->link("Generar Reportes",array("controller"=>"reportes","action"=>"generar_reportes"),array("before"=>"modales('generar_reportes','modal-ficha')","complete"=>"fin_ajax('generar_reportes')","update"=>"generar_reportes","class"=>"btn btn-inverse")); ?><br>
