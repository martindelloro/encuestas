...
<div class="row-fluid">
    <div class="span3"><?php echo $this->Form->input("password",array("type"=>'text',"label"=>"Password")); ?></div>
    <div class="span3"><?php echo $this->Form->input("password_rep",array("type"=>'text',"label"=>"Repetir Password")); ?></div>
