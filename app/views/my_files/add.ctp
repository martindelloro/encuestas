...
<div class="well contenedor-well fondo-1">
 ...
 <div class="well contenedor-well fondo-1">   
    <div class="row-fluid">
    <div class="span8"><?php echo $form->create('MyFile', array('action' => 'add', 'type' => 'file')); ?></div>
    <div class="span8"> <?php echo $form->file('File'); ?>
    <div class="span8"> <?php echo $form->submit('Upload'); ?>
